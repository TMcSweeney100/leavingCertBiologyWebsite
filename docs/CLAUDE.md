...
- **UI component location:** `frontend/components/ui/` (shadcn primitives — currently just `button.tsx`) and `frontend/components/bipi/` (not created yet — app-specific components, Phase 3+).
