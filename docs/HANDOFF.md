...
## Where things are (17 Sep 2026: 2A and 2B built)
...
- **All six Phase 2 plans are written** (2A–2F, in `docs/superpowers/plans/2026-09-16-pilot-2*.md`, listed at the top of the roadmap). Continue with 2C next.
...
- **Content reviews for Gate P2:** Tim reads `V2__science_templates.sql` (now built) against the PDFs — checklist in plan 2B Task 5 Step 3 (stages/hours/descriptions, sections/bands, checkpoints and quotes, prompts, per subject; plus whether the checkpoint wording is fit to show teachers, Q1) — and V3–V4 once 2C builds them (checklist in plan 2C Task 4). Katelyn reviews the Biology checkpoints. Q1 names the other three reviewers. Record each review here with date and what was checked once done.
